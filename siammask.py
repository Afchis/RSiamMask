...
class SiamMask(nn.Module):
    ...
    def add_rpn_loss(self, label_cls, label_loc, lable_loc_weight, label_mask, label_mask_weight, rpn_pred_cls, rpn_pred_loc, rpn_pred_mask):
    ...
    def forward(self, input):
        ...
        if self.training:
            rpn_loss_cls, rpn_loss_loc, rpn_loss_mask, iou_acc_mean, iou_acc_5, iou_acc_7 = \
                self.add_rpn_loss(label_cls, label_loc, lable_loc_weight, label_mask, label_mask_weight,
